...
function Assets() {
	...
	const { data, refetch: updateAssets } = useHyperwebAssets();
	...
	return (
		<div className='scrollbar-neutral mx-auto flex max-w-[720px] flex-col items-center gap-9 font-inter'>
			...
			{!address ? (
				...
				<>
					<div className='flex w-full items-center justify-between rounded-lg bg-card p-6'>
						<div>
...
export default withContractLayout(Assets);
