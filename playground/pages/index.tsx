...
const features = [
	...
	},
	{
		...
		href: '/playground/interact?tab=execute',
		icon: Play,
	...
	},
	{
		...
		href: '/playground/interact?tab=query',
		icon: DatabaseZap,
			...
			<div className='relative rounded-xl border border-border/40 bg-card/50 p-6 shadow-sm backdrop-blur-sm'>
				<div className='grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-3'>
					{features.map((feature) => (
						<Link href={feature.href} key={feature.href} passHref legacyBehavior>
							<a
...
export default withContractLayout(ContractPlaygroundIndex, {
	requiresHyperwebSetup: false,
});
